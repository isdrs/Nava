...
//        }
    ...
    func SetPlayingMusicView() -> Void{
        ...
        self.btnIranCell.frame.origin = CGPoint(x: playingMusicView.frame.size.width - btnIranCell.frame.size.width - Tools.screenWidth * 0.01, y: btnHamrah.frame.origin.y)
